...
function cargarClientes() {
    ...
    table.on('click', '.edit', function (e) {
        ...
        $.ajax({
            ...
            type: "POST",
            datatype: "json",
            url: "/Mantenedores/EditarCliente",
    ...
    table.on('click', '.delete', function (e) {
        ...
        $.ajax({
            ...
            type: "POST",
            datatype: "json",
            url: "/Mantenedores/EliminarCliente",
            data: JSON.stringify(data),
            success: function (data) {
                if (data.HasError === true) ShowError("¡Error!", data.Message);
                else {
...
function guardarCliente() {
    ...
    if (rut.length <= 0) ShowError("¡Error¡", "Debe ingresar el rut del cliente");
        ...
        $.ajax({
            ...
            type: "POST",
            datatype: "json",
            url: "/Mantenedores/GuardarCliente",
            data: JSON.stringify(data),
            beforeSend: function () {
...
function editarCliente() {
    ...
    if (rut.length <= 0) ShowError("¡Error¡", "Debe ingresar el rut del cliente");
        ...
        $.ajax({
            ...
            type: "POST",
            datatype: "json",
            url: "/Mantenedores/GuardarEditCliente",
            data: JSON.stringify(data),
            success: function (data) {
                if (data["HasError"] === true) ShowError("¡Error!", data["Message"]);
                else {
