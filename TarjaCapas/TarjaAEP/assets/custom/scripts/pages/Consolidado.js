...
function CargarCons() {
    ...
    table.on('click', '.edit', function (e) {
        ...
        $.ajax({
            ...
            type: "POST",
            datatype: "json",
            url: "/Consolidado/EditarPlanificacion",
            ...
            success: function (data) {
                if (data.HasError === true) ShowError("¡Error!", data.Message);
                    ...
                    $("#txtReserva").val(planes[0].gls_reserva); //req
                    $("#ddlTerminal").val(planes[0].cod_terminal); //req
                    $("#ddlNave").val(planes[0].cod_nave); //req
                    $("#txtViaje").val(planes[0].n_viaje); //req
                    ...
                    $("#txtContenedor").val(planes[0].gls_contenedor); //req
                    $("#ddlIso").val(planes[0].cod_iso); //req
                    $("#txtSello1").val(planes[0].gls_sello); //req
                    $("#txtFecha").val(""); //req
                    $("#ddlTarjador").val(planes[0].rut_tarjador);

                    $("#guardarPlanCons").css("display", "none");
                    $("#editarEncabezadoPlan").css("display", "inline");
...
function guardarEncabezadoPlan() {
    var reserva = $("#txtReserva").val().trim(); //req
    ...
    if (reserva.length <= 0) ShowError("¡Error¡", "Debe ingresar la reserva");
        ...
        $.ajax({
            ...
            type: "POST",
            datatype: "json",
            url: "/Consolidado/GuardarPlanCons",
            data: JSON.stringify(data),
            beforeSend: function () {
...
function guardarDocCons() {
    ...
    if (nroDoc.length <= 0) ShowError("¡Error¡", "Debe ingresar el numero de documento");
        ...
        $.ajax({
            ...
            type: "POST",
            datatype: "json",
            url: "/Consolidado/GuardarDocCons",
            data: JSON.stringify(data),
            beforeSend: function () {
...
function guardarMercCons() {
    ...
    if (marca.length <= 0) ShowError("¡Error¡", "Debe ingresar la marca");
        ...
        $.ajax({
            ...
            type: "POST",
            datatype: "json",
            url: "/Consolidado/GuardarMercCons",
            data: JSON.stringify(data),
            beforeSend: function () {
...
function cargarMercCons() {
    ...
    $.ajax({
        ...
        type: "POST",
        datatype: "json",
        url: "/Consolidado/ObtLisMercCons",
        data: JSON.stringify(data),
        success: function (dataCS) {
            if (dataCS.TieneError === true) ShowError("¡Error!", dataCS.Mensaje);
            else {
    ...
    table.on('click', '.deleteMerc', function (e) {
        ...
        $.ajax({
            ...
            type: "POST",
            datatype: "json",
            url: "/Consolidado/EliminarMercCons",
            data: JSON.stringify(data),
            beforeSend: function () {
                ShowProcessing($(this), true, "");
            },
...
function finalizarPlanCons() {
    var table = $("#tbMercsConso").dataTable();
    table.fnClearTable();
    var docTable = $("#tbDocsConso").dataTable();
    docTable.fnClearTable();
    CargarCons();
    $("#guardarPlanCons").css("display", "block");
    $("#editarEncabezadoPlan").css("display", "none");
    limpiarForm();
    $("#divDocsCons :input").prop('disabled', true);
    $("#divMercCons :input").prop('disabled', true);
    $("#divPlanCons :input").prop('disabled', false);
...
//********************************************************//
// Función:  agregarDocCons()
// Objetivo: Habilita form para agregar nuevo doc
// Autor:    Franco Caamaño Saavedra
// Fecha:    18/07/2016
//********************************************************//
function agregarDocCons() {
    $("#txtNroDoc").val("");
...
function editarEncabezadoPlan() {
    ...
    if (reserva.length <= 0) ShowError("¡Error¡", "Debe ingresar la reserva");
        ...
        $.ajax({
            ...
            type: "POST",
            datatype: "json",
            url: "/Consolidado/GuardarPlanEditCons",
            data: JSON.stringify(data),
            beforeSend: function () {
