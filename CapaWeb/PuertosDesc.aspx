<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.master" AutoEventWireup="true" CodeFile="PuertosDesc.aspx.cs" Inherits="PuertosDesc" %>
    ...
    <script type="text/javascript">
        function eliminar(id) {
            ...
            bootbox.confirm({
                ...
                callback: function (result) { if (result) { eliminarBootbox(codigo); } else { location.href = "PuertosDesc.aspx"; } }
            });
        }
        ...
        function eliminarBootbox(codigo) {
            $.ajax({
                type: "POST",
                url: "PuertosDesc.aspx/eliminarPuertos",
                data: '{codigo: "' + codigo + '"}',
            ...
            function OnSuccess(response) {
                ...
                if (response.d == 0) {
                    location.href = "PuertosDesc.aspx";
                } else {
                    alerta('No puede eliminar este puerto. \n Asegurese que no hay planificaciones asociadas a este puerto.');
                }
            }
        }
        ...
        function modificar(id) {
            ...
            $.ajax({
                type: "POST",
                url: "PuertosDesc.aspx/modificarPuertos",
                data: '{codigo: "' + codigo + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: OnSuccess,
            ...
            function OnSuccess(response) {
                ...
                txtCod.value = response.d.Cod_puerto;
                txtNombre.value = response.d.Nom_puerto;
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Nuevo Puerto</h4>
                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <asp:Label ID="lbl_mensaje_codigo" runat="server" ForeColor="Red" Text="Debe ingresar el codigo del puerto"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:Label ID="lbl_mensaje_Nombre" runat="server" ForeColor="Red" Text="Debe seleccionar el nombre del puerto"
                                                Visible="false"></asp:Label>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Modificar Puertos</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-body">
                                <div class="form-group">
                                    <label>
                                        Codigo</label>
                                    <asp:TextBox ID="txtModCOd" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <label>
                                        Nombre</label>
