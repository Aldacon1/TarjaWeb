<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.master" AutoEventWireup="true" CodeFile="TipoDocumento.aspx.cs" Inherits="TipoDocumento" %>
    ...
    <script type="text/javascript">
        function eliminar(id) {
            ...
            bootbox.confirm({
                ...
                callback: function (result) { if (result) { eliminarBootbox(codigo); } else { location.href = "TipoDocumento.aspx"; } }
            });
        }
        ...
        function eliminarBootbox(codigo) {
            $.ajax({
                type: "POST",
                url: "TipoDocumento.aspx/eliminarTipoDocs",
                data: '{codigo: "' + codigo + '"}',
            ...
            function OnSuccess(response) {
                if (response.d == 0) {
                    location.href = "TipoDocumento.aspx";
                } else {
                    alerta('No puede eliminar este tipo de documento. \n Asegurese que no hay tarjas asociadas a este tipo de documento.');
                }
            }
        }
        ...
        function modificar(id) {
            ...
            $.ajax({
                type: "POST",
                url: "TipoDocumento.aspx/modificarTipoDoc",
                data: '{codigo: "' + codigo + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: OnSuccess,
            ...
            function OnSuccess(response) {
                var txtCod = document.getElementById("<%=txtModCod.ClientID%>");
                var txtNombre = document.getElementById("<%=txtNomMod.ClientID%>");


                txtCod.value = response.d.Cod_TipoDoc;
                txtNombre.value = response.d.Nom_doc;
                                ...
                                <div class="col-md-12">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtTipoDoc" runat="server" CssClass="form-control" onKeyUp="this.value=this.value.toUpperCase();"></asp:TextBox>
                                            <asp:Label ID="lbl_mensaje_tipo" runat="server" ForeColor="Red" Text="El tipo de documento es obligatorio"
                                                Visible="false"></asp:Label>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Modificar Tipo de Documento</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-body">
                                <div class="form-group">
                                    <label>
                                        Codigo</label>
                                    <asp:TextBox ID="txtModCod" runat="server" CssClass="form-control" onkeydown="return jsDecimals(event);"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <label>
                                        Tipo de Documento</label>
