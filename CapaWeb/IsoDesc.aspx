<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.master" AutoEventWireup="true" CodeFile="IsoDesc.aspx.cs" Inherits="IsoDesc" %>
    ...
    <script type="text/javascript">
        ...
        function eliminarBootbox(codigo) {
            ...
            function OnSuccess(response) {
                ...
                if (response.d == 0) {
                    location.href = "IsoDesc.aspx";
                } else {
                    alerta('No puede eliminar este codigo ISO. \n Asegurese que no hay tarjas asociadas a este codigo.');
                }
            }
        }
        ...
        function modificar(id) {
            ...
            function OnSuccess(response) {
                ...
                var txtTara = document.getElementById("<%= txtTaraMod.ClientID%>");


                txtCod.value = response.d.cod_iso;
                txtNombre.value = response.d.desc_iso;
                txtTara.value = response.d.tara;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
        <div class="col-md-6">
            <a class="btn default" data-toggle="modal" href="#responsive">Agregar Iso </a>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Nuevo Iso</h4>
                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label>
                                                Codigo</label>
                                            <asp:TextBox ID="txtCodigo" CssClass="form-control" runat="server" onKeyUp="this.value=this.value.toUpperCase();"></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:Label ID="lbl_mensjae_Nombre" runat="server" ForeColor="Red" Text="Nombre es obligatorio"
                                                Visible="false"></asp:Label>
                                        </div>
                                        <div class="form-group">
                                            <label>
                                            ...
                                            <div class="input-icon right">
                                                <asp:TextBox ID="txtTarad" runat="server" CssClass="form-control" onkeydown="return jsDecimals(event);"></asp:TextBox>
                                                <asp:Label ID="lbl_mensaje_tara" runat="server" ForeColor="Red" Text="TARA es obligatorio"
                                                    Visible="false"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Modificar Iso</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-body">
                                <div class="form-group">
                                    <label>
                                        Codigo</label>
                                    <asp:TextBox ID="txtCodMod" runat="server" CssClass="form-control" onKeyUp="this.value=this.value.toUpperCase();"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <label>
                                        Nombre</label>
                                ...
                                <div class="form-group">
                                    <label>
                                        TARA</label>
                                    <asp:TextBox ID="txtTaraMod" runat="server" CssClass="form-control" onKeyUp="return jsDecimals(event);">
                                    </asp:TextBox>
                                </div>
                            </div>
                        </div>
