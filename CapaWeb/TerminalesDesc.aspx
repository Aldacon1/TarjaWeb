<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.master" AutoEventWireup="true" CodeFile="TerminalesDesc.aspx.cs" Inherits="TerminalesDesc" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cssReferences" runat="Server">
    ...
    <script type="text/javascript">
        function eliminar(id) {
            var idTerminal = id;
            bootbox.confirm("Realmente quieres eliminar este articulo?", function (result) {
                if (result) {
                    eliminarTerminal(idTerminal);
                } else {
                    location.href = "TerminalesDesc.aspx";
                }
            });

        }
        function eliminarTerminal(idTerminal) {
            var codigo = idTerminal;
            $.ajax({
                type: "POST",
                url: "TerminalesDesc.aspx/eliminarTerminal",
                data: '{codigo: "' + codigo + '"}',
            ...
            function OnSuccess(response) {
                if (response.d == 0) {
                    ...
                    alerta('No puede eliminar este terminal. \n Asegurese que no hay personas asociadas a este terminal.');
                }
            }
        ...
        function modificar(id) {
            ...
            $.ajax({
                type: "POST",
                url: "TerminalesDesc.aspx/modificarTerminal",
                data: '{codigo: "' + idTerminal + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: OnSuccess,
                failure: function (response) {
            ...
            function OnSuccess(response) {
                ...
                txtCod.value = response.d.Age_cod;
                txtNombre.value = response.d.Age_nom;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <div class="portlet-body">
                            <table class='table table-striped table-hover table-bordered dataTable no-footer' id="sample_2">
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:Panel runat="server" ID="pnlTablaTerminales">
                                            <asp:PlaceHolder ID="pHolderTerminales" runat="server"></asp:PlaceHolder>
                                        </asp:Panel>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </table>
    ...
    <div class="row">
        <div class="col-md-6">
            <a class="btn default" data-toggle="modal" href="#responsive">Agregar Terminal </a>
        </div>
    </div>

    <!-- Modal Agregar Terminal -->
    <div id="responsive" class="modal fade bs-modal-lg" tabindex="-1" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title">Nuevo Terminal</h4>
                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <asp:Label ID="lbl_mensaje_codigo" runat="server" ForeColor="Red" Text="Debe ingresar un codigo"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:Label ID="lbl_mensaje_nombre" runat="server" ForeColor="Red" Text="Debe ingresar el nombre del terminal."
                                                Visible="false"></asp:Label>
                                        </div>
